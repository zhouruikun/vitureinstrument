...
// 创建导航图
function createMaster(container_num) {
 ...
 * 创建 detailContainer 并 append 到 container 中
 */
detailContainer2 = document.createElement('div');
container2.appendChild(detailContainer2);

/*
 * 创建 masterContainer 并 append 到 container 中
 */
masterContainer2 = document.createElement('div');
masterContainer2.style.position = 'relative';
masterContainer2.style.top = '0px';
masterContainer2.style.height = '100px';
masterContainer2.style.width = '100%';
container2.appendChild(masterContainer2);
